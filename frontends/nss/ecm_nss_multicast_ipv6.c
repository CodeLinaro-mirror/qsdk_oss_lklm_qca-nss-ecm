...
int ecm_nss_multicast_ipv6_init(struct dentry *dentry)
{
	ecm_debugfs_create_u32("multicast_accelerated_count", S_IRUGO, dentry,
				(u32 *)&ecm_nss_multicast_ipv6_accelerated_count);
	ecm_debugfs_create_u32("ecm_nss_multicast_ipv6_stop", S_IRUGO | S_IWUSR, dentry,
				(u32 *)&ecm_front_end_ipv6_mc_stopped);

	/*
	 * Register multicast update callback to MCS snooper
	 */
	if (mc_bridge_ipv6_update_callback_register(ecm_nss_multicast_ipv6_br_update_event_callback)) {
	 ...
	 */
	if (!ip6mr_register_mfc_event_offload_callback(ecm_nss_multicast_ipv6_mfc_update_event_callback)) {
