									...
									ecm_tracker_sender_type_t sender)
{
	...
	if (!ecm_sfe_ipv4_accel_pending_set(feci)) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_ACCEL_NOT_PERMITTED);
	...
	if (!nim) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_NO_MEM);
	...
	from_ifaces_first = ecm_db_connection_interfaces_get_and_ref(feci->ci, from_ifaces, ECM_DB_OBJ_DIR_FROM);
	if (from_ifaces_first == ECM_DB_IFACE_HEIRARCHY_MAX) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_NO_FROM_INTERFACES);
		DEBUG_WARN("%px: Accel attempt failed - no interfaces in from_interfaces list!\n", feci);
	...
	if (to_ifaces_first == ECM_DB_IFACE_HEIRARCHY_MAX) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_NO_TO_INTERFACES);
	...
	if ((from_sfe_iface_id < 0) || (to_sfe_iface_id < 0)) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_INVALID_BOTTOM_IFACE);
	...
	for (list_index = from_ifaces_first; !rule_invalid && (list_index < ECM_DB_IFACE_HEIRARCHY_MAX); list_index++) {
		...
		case ECM_DB_IFACE_TYPE_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_BRIDGE_CASCADE);
		...
		case ECM_DB_IFACE_TYPE_OVS_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_OVS_BRIDGE_CASCADE);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_OVS_BRIDGE_UNSUPPORTED);
#endif
			break;
			...
			if (dev) {
				if (((dev->priv_flags_ext & IFF_EXT_GRE_V4_TAP) && proto == IPPROTO_GRE)
					...
					if (!ecm_interface_tunnel_mtu_update(saddr, daddr, db_iface_type, &(nircm->conn_rule.flow_mtu))) {
						rule_invalid = true;
						ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_GRETAP_OR_L2TPV3_IFACE_MTU_UNKNOWN);
		...
		case ECM_DB_IFACE_TYPE_GRE_TUN:
			...
			if (proto == IPPROTO_GRE) {
				...
				if (!ecm_interface_tunnel_mtu_update(saddr, daddr, ECM_DB_IFACE_TYPE_GRE_TUN, &(nircm->conn_rule.flow_mtu))) {
					rule_invalid = true;
					ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_GRETUN_IFACE_MTU_UNKNOWN);
		...
		case ECM_DB_IFACE_TYPE_PPPOE:
			 ...
			 */
			if (interface_type_counts[ii_type] != 0) {
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_MORE_THAN_ONE_PPPOE_UNSUPPORTED);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_PPPOE_FLOW_INVALID);
#endif
			break;
		case ECM_DB_IFACE_TYPE_VLAN:
			...
			if (interface_type_counts[ii_type] > 1) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_ONLY_TWO_VLANS_SUPPORTED);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_VLAN_NOT_ENABLED);
		...
		case ECM_DB_IFACE_TYPE_IPSEC_TUNNEL:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_ONLY_ONE_IPSEC_SUPPORTED);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_IPSEC_NOT_ENABLED);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_PPTP_NOT_ENABLED);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_FROM_IFACE_LAG_NOT_ENABLED);
	...
	for (list_index = to_ifaces_first; !rule_invalid && (list_index < ECM_DB_IFACE_HEIRARCHY_MAX); list_index++) {
		...
		case ECM_DB_IFACE_TYPE_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_BRIDGE_CASCADE);
				DEBUG_TRACE("%px: Bridge - ignore additional\n", feci);
				break;
			}
		...
		case ECM_DB_IFACE_TYPE_OVS_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_OVS_BRIDGE_CASCADE);
				DEBUG_TRACE("%px: OVS Bridge - ignore additional\n", feci);
				break;
			}
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_OVS_BRIDGE_UNSUPPORTED);
#endif
			break;
		...
		case ECM_DB_IFACE_TYPE_PPPOE:
			 ...
			 */
			if (interface_type_counts[ii_type] != 0) {
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_MORE_THAN_ONE_PPPOE_UNSUPPORTED);
				DEBUG_TRACE("%px: PPPoE - additional unsupported\n", feci);
				rule_invalid = true;
				break;
			}
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_PPPOE_FLOW_INVALID);
#endif
			break;
		case ECM_DB_IFACE_TYPE_VLAN:
#ifdef ECM_INTERFACE_VLAN_ENABLE
			...
			if (interface_type_counts[ii_type] > 1) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_ONLY_TWO_VLANS_SUPPORTED);
				DEBUG_TRACE("%px: VLAN - additional unsupported\n", feci);
				break;
			}
			ecm_db_iface_vlan_info_get(ii, &vlan_info);
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_VLAN_NOT_ENABLED);
			DEBUG_TRACE("%px: VLAN - unsupported\n", feci);
#endif
			break;
		case ECM_DB_IFACE_TYPE_IPSEC_TUNNEL:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_ONLY_ONE_IPSEC_SUPPORTED);
				DEBUG_TRACE("%px: IPSEC - additional unsupported\n", feci);
				break;
			}
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_IPSEC_NOT_ENABLED);
			DEBUG_TRACE("%px: IPSEC - unsupported\n", feci);
#endif
			break;
...
#else
			rule_invalid = true;
			ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_TO_IFACE_LAG_NOT_ENABLED);
			DEBUG_TRACE("%px: LAG - unsupported\n", feci);
#endif
			break;
	...
	if (ecm_sfe_mht_enable && (!ecm_sfe_common_get_mht_port_id(feci, from_sfe_iface, to_sfe_iface,
		...
		ecm_db_connection_interfaces_deref(from_ifaces, from_ifaces_first);
		ecm_db_connection_interfaces_deref(to_ifaces, to_ifaces_first);
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_MHT_PORT_FAIL);
		ecm_sfe_ipv4_accel_pending_clear(feci, ECM_FRONT_END_ACCELERATION_MODE_DECEL);
		kfree(nim);
		return;
	}
	...
	if (regen_occurrances != ecm_db_connection_regeneration_occurrances_get(feci->ci)) {
		ecm_sfe_stats_v4_inc(feci, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED, ECM_SFE_STATS_V4_EXCEPTION_NON_PORTED_REGEN_OCCURRED);
...
/*
 * ecm_sfe_non_ported_ipv4_init()
 */
void ecm_sfe_non_ported_ipv4_init(struct dentry *dentry)
{
