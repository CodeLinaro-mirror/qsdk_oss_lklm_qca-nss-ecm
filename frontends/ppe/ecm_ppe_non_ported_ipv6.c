								...
								ecm_tracker_sender_type_t sender)
{
	...
	if (!ecm_ppe_ipv6_accel_pending_set(feci)) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_ACCEL_NOT_PERMITTED);
	...
	if (feci->ci->vlan_filter_valid) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_BRIDGE_VLAN_FILTER_UNSUPPORTED);
	...
	if (!pd6rc) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_NO_MEM);
	...
	if (from_ifaces_first == ECM_DB_IFACE_HEIRARCHY_MAX) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_NO_FROM_INTERFACES);
	...
	if (to_ifaces_first == ECM_DB_IFACE_HEIRARCHY_MAX) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_NO_TO_INTERFACES);
	...
	if ((from_ppe_iface_id < 0) || (to_ppe_iface_id < 0)) {
		...
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_INVALID_BOTTOM_IFACE);
	...
	if ((pd6rc->top_rule.rx_if < 0) || (pd6rc->top_rule.tx_if < 0)) {
		ecm_db_connection_interfaces_deref(from_ifaces, from_ifaces_first);
		ecm_db_connection_interfaces_deref(to_ifaces, to_ifaces_first);
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_INVALID_TOP_IFACE);
	...
	for (list_index = from_ifaces_first; !rule_invalid && (list_index < ECM_DB_IFACE_HEIRARCHY_MAX); list_index++) {
		...
		if (ae_iface_id < 0) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_INVALID_IFACE_ID);
		...
		if (ecm_front_end_common_intf_ingress_qdisc_check(iface_id)) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_INGRESS_QDISC_UNSUPPORTED);
		...
		if (ecm_front_end_common_intf_qdisc_check(iface_id, &is_ppeq) && !is_ppeq) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_QDISC_UNSUPPORTED);
		...
		case ECM_DB_IFACE_TYPE_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_BRIDGE_CASCADE);
		...
		case ECM_DB_IFACE_TYPE_OVS_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_OVS_BRIDGE_CASCADE);
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_OVS_BRIDGE_UNSUPPORTED);
			...
			if (dev) {
				...
				if ((dev->priv_flags_ext & IFF_EXT_GRE_V6_TAP) && proto == IPPROTO_GRE) {
					...
					if (!ecm_interface_tunnel_mtu_update(saddr, daddr, ECM_DB_IFACE_TYPE_GRE_TAP, (uint32_t *)&(pd6rc->conn_rule.flow_mtu))) {
						rule_invalid = true;
						ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_GRETAP_IFACE_MTU_UNKNOWN);
		...
		case ECM_DB_IFACE_TYPE_PPPOE:
			 ...
			 */
			if (interface_type_counts[ii_type] != 0) {
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_MORE_THAN_ONE_PPPOE_UNSUPPORTED);
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_PPPOE_FLOW_INVALID);
#endif
			break;
		...
		case ECM_DB_IFACE_TYPE_VLAN:
		{
			...
			if (interface_type_counts[ii_type] > 1) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_ONLY_TWO_VLANS_SUPPORTED);
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_FROM_IFACE_VLAN_NOT_ENABLED);
	...
	for (list_index = to_ifaces_first; !rule_invalid && (list_index < ECM_DB_IFACE_HEIRARCHY_MAX); list_index++) {
		...
		if (ae_iface_id < 0) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_INVALID_IFACE_ID);
			DEBUG_TRACE("%px: PPE doesn't support iface_id:(%d) type:%d(%s) interface",
					feci, iface_id, ii_type, ii_name);
			ecm_db_connection_interfaces_deref(from_ifaces, from_ifaces_first);
			ecm_db_connection_interfaces_deref(to_ifaces, to_ifaces_first);
		...
		if (ecm_front_end_common_intf_ingress_qdisc_check(iface_id)) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_INGRESS_QDISC_UNSUPPORTED);
			DEBUG_TRACE("%px: PPE doesn't support ingress qdisc for this flow:(%d) type:%d(%s) interface",
					feci, iface_id, ii_type, ii_name);
			ecm_db_connection_interfaces_deref(from_ifaces, from_ifaces_first);
			ecm_db_connection_interfaces_deref(to_ifaces, to_ifaces_first);
...
#ifdef ECM_FRONT_END_PPE_QOS_ENABLE
		if (ecm_front_end_common_intf_qdisc_check(iface_id, &is_ppeq) && !is_ppeq) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_QDISC_UNSUPPORTED);
			DEBUG_TRACE("%px: PPE doesn't support qdisc for this flow:(%d) type:%d(%s) interface",
					feci, iface_id, ii_type, ii_name);
			ecm_db_connection_interfaces_deref(from_ifaces, from_ifaces_first);
			ecm_db_connection_interfaces_deref(to_ifaces, to_ifaces_first);
		...
		case ECM_DB_IFACE_TYPE_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_BRIDGE_CASCADE);
				DEBUG_TRACE("%px: Bridge - ignore additional\n", feci);
				break;
			}
		...
		case ECM_DB_IFACE_TYPE_OVS_BRIDGE:
			...
			if (interface_type_counts[ii_type] != 0) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_OVS_BRIDGE_CASCADE);
				DEBUG_TRACE("%px: OVS Bridge - ignore additional\n", feci);
				break;
			}
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_OVS_BRIDGE_UNSUPPORTED);
			DEBUG_TRACE("%px: OVS Bridge - not supported\n", feci);
#endif
			break;
		...
		case ECM_DB_IFACE_TYPE_PPPOE:
			 ...
			 */
			if (interface_type_counts[ii_type] != 0) {
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_MORE_THAN_ONE_PPPOE_UNSUPPORTED);
				DEBUG_TRACE("%px: PPPoE - additional unsupported\n", feci);
				rule_invalid = true;
				break;
			}
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_PPPOE_FLOW_INVALID);
#endif
			break;
		...
		case ECM_DB_IFACE_TYPE_VLAN:
		{
			...
			if (interface_type_counts[ii_type] > 1) {
				 ...
				 */
				rule_invalid = true;
				ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_ONLY_TWO_VLANS_SUPPORTED);
				DEBUG_TRACE("%px: VLAN - additional unsupported\n", feci);
				break;
			}
			ecm_db_iface_vlan_info_get(ii, &vlan_info);
...
#else
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_VLAN_NOT_ENABLED);
			DEBUG_TRACE("%px: VLAN - unsupported\n", feci);
#endif
			break;
		}
		...
		case ECM_DB_IFACE_TYPE_IPSEC_TUNNEL:
			...
			rule_invalid = true;
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_TO_IFACE_IPSEC_NOT_ENABLED);
			DEBUG_TRACE("%px: IPSEC - unsupported\n", feci);
#endif
			break;
	...
	if (!(ppe_drv_iface_check_wifi_flow(pd6rc->conn_rule.rx_if, pd6rc->conn_rule.tx_if)) &&
		...
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_PPE_OFFLOAD_DISABLED);
	...
	if (regen_occurrances != ecm_db_connection_regeneration_occurrances_get(feci->ci)) {
		ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_REGEN_OCCURRED);
	...
	if (ppe_tx_status == PPE_DRV_RET_SUCCESS) {
		...
		if (feci->stats.flush_happened) {
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_IMMEDIATE_FLUSH);
		...
		if (!ecm_ppe_non_ported_ipv6_accelerate_done(feci)) {
			...
			ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_DECELERATE_PENDING);
	 ...
	 */
	ecm_ppe_stats_v6_inc(feci, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED, ECM_PPE_STATS_V6_EXCEPTION_NON_PORTED_PPE_ACCEL_FAILED);
...
/*
 * ecm_ppe_non_ported_ipv6_init()
 */
void ecm_ppe_non_ported_ipv6_init(struct dentry *dentry)
{
