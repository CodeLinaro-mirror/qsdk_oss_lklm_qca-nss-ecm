...
/**
 * Decelerates connections on a particular MAC address.
 *
 ...
 * None.
 */
extern void ecm_classifier_pcc_decel_by_mac_addr(uint8_t *mac_addr);

/**
 * Decelerates connections on a particular IPv4 address.
 *
 ...
 * None.
 */
extern void ecm_classifier_pcc_decel_by_ip_addr_v4(__be32 ip_addr);

/**
 * Decelerates connections on a particular IPv6 address.
 *
 * @param	ip6_addr	The IPv6 address.
 *
 * @return
 * None.
 */
extern void ecm_classifier_pcc_decel_by_ip_addr_v6(struct in6_addr ip6_addr);
